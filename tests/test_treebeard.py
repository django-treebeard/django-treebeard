...
class TestTreeSorted(TestTreeBase):
    ...
    def test_move_sorted_back_under_previous_parent(self, sorted_model):
        ...
        root = sorted_model.add_root(**{"val1": 1, "val2": 1, "desc": "rt"})
        parent = root.add_child(**{"val1": 2, "val2": 1, "desc": "prt"})
        for val1, desc in ((1, "ac1"), (2, "ac2"), (3, "ac3")):
            parent = sorted_model.objects.get(pk=parent.pk)
            parent.add_child(**{"val1": val1, "val2": 1, "desc": desc})
        ...
        ac1.move(root, "sorted-child")

        # ... and move it back under its old parent.
        ac1 = sorted_model.objects.get(desc="ac1")
        parent = sorted_model.objects.get(pk=parent.pk)
        ac1.move(parent, "sorted-child")
