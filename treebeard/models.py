...
from treebeard.deprecation import RemovedInTreebeard7Warning, moved_manager_classmethod, moved_manager_method
...
def _inject_moved_method_back_compat():
    ...
    for method in moved_classmethods:
        setattr(Node, method, moved_manager_classmethod(method))
    ...
    for method in moved_methods:
        setattr(Node, method, moved_manager_method(method))
