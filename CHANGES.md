...
Django's design patterns, and provides much more flexibility with their use. It also means
that the model class is as slim as possible, avoiding conflicts with code layered on top.
